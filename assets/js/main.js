!(function (e) {
  ...
  document.addEventListener("mousemove", function (e) {
    ...
    (document.onkeydown = function (e) {
      return (
        123 != event.keyCode &&
        (!e.ctrlKey || !e.shiftKey || e.keyCode != "I".charCodeAt(1)) &&
        (!e.ctrlKey || !e.shiftKey || e.keyCode != "C".charCodeAt(1)) &&
        (!e.ctrlKey || !e.shiftKey || e.keyCode != "J".charCodeAt(1)) &&
        (!e.ctrlKey || e.keyCode != "U".charCodeAt(1)) &&
        void 0
      );
    });
})(jQuery);
