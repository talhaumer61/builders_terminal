      ...
      events: {
        attachEvents: function () {
          ...
          (e.onTouchStart = k.bind(e)),
            ...
            (e.onClick = G.bind(e)),
            (e.onLoad = X.bind(e)),
            Y || (t.addEventListener("touchstart", N), (Y = !0)),
            B(e, "on");
        },
    ...
    function (e) {
      ...
      function u() {
        ...
        p.forEach((e, r) => {
          if (
            ("fraction" === s.type &&
              (e.querySelectorAll(U(s.currentClass)).forEach((e) => {
            ...
            "custom" !== e.type && (s.innerHTML = r || ""),
              "bullets" === e.type &&
                t.pagination.bullets.push(
                  ...s.querySelectorAll(U(e.bulletClass))
                );
          }),
    ...
    function (e) {
      ...
      function h(e) {
        ...
        (t.pagination &&
          ...
          t.pagination &&
            a.matches(U(t.params.pagination.bulletClass)) &&
            a.click());
      }
      function g() {
        return (
              ...
              g() &&
                t.pagination.bullets.forEach((s) => {
                  t.params.pagination.clickable &&
                    ...
                    s.matches(U(t.params.pagination.bulletActiveClass))
      ...
      te({
        ...
        setTransition: (e) => {
          ...
          s.forEach((t) => {
            ...
            ae({ swiper: t, duration: e, transformElements: s });
        },
        recreateShadows: () => {
          t.params.flipEffect,
            t.slides.forEach((e) => {
      ...
      te({
        ...
        setTransition: (e) => {
          ...
          s.forEach((t) => {
            ...
            ae({ swiper: t, duration: e, transformElements: s, allSlides: !0 });
        },
