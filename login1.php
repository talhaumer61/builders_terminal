...
<head>
    ...
    <title>Login - Builders Terminal</title>
    <style>
        ...
        <div class="wrapper">
            ...
            <div class="form-container">
              <div class="form-inner">
                  <form class="login auth-form"  method="POST" autocomplete="off">
                      <div class="field">
                          <input name="login_id" type="email" placeholder="Email" required>
                      </div>
                      <div class="field">
                      ...
                      '.$errorMessage.'
                      ';
                      // echo '<div class="pass-link"><a href="#">Forgot password?</a></div>';
                      echo'
                      <div class="p-1">
                        <button  class="btn btn-primary" name="submit_signin" type="submit">Login</button>
                      </div>
                      <div class="signup-link">Not a member? <a href="signup.php">Signup now</a></div>
                      <div class="signup-link">Are you a tradeperson? <a href="seller_signup.php">Register now</a></div>
                  </form>
              </div>
            </div>
        </div>
